            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    if (h.globals.isXNumeric) {
                        var f = c;
                        h.globals.seriesX[c].length || (f = h.globals.maxValsInArrayIndex), h.globals.seriesX[f][g] && (i = (h.globals.seriesX[f][g] - h.globals.minX) / this.xRatio - r * this.seriesLen / 2)
                    }
            ...
            value: function() {
                ...
                return new Promise((function(s, r) {
                    ...
                    if (null !== o && (l.xAxisLabelCorrections(o.xAxisTickWidth), h.setYAxisTextAlignments(), a.config.yaxis.map((function(t, e) {
                        ...
                        }))), "back" === a.config.annotations.position && (a.globals.dom.Paper.add(a.globals.dom.elAnnotations), i.annotations.drawAxesAnnotations()), !a.globals.noData) {
