                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 ps-0">
                                        ...
                                        <div class="text-muted mb-1 fs-12"> <span class="text-dark fw-semibold fs-20 lh-1 vertical-bottom"> <?php echo $d_data['total_sales'] ?>
                                            </span> </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 ps-0">
                                        ...
                                        <div class="text-muted mb-1 fs-12"> <span class="text-dark fw-semibold fs-20 lh-1 vertical-bottom">
                                                $<?php echo $d_data['total_price'] ?> </span> </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 ps-0">
                                        ...
                                        <div class="text-muted mb-1 fs-12"> <span class="text-dark fw-semibold fs-20 lh-1 vertical-bottom">
                                                <?php echo $d_data['total_customer'] ?>
                                            </span> </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 ps-0">
                                        ...
                                        <div class="text-muted mb-1 fs-12"> <span class="text-dark fw-semibold fs-20 lh-1 vertical-bottom"> <?php echo $d_data['total_orders'] ?>
                                            </span> </div>
