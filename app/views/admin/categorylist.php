                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hstack gap-2 fs-15">
                                                    <a href="<?php echo ASSETS_URL_ROOT . '/admin/updatecategory' . '?id=' . $c_data['CateID'] ?>" class="btn btn-icon btn-sm btn-info-light"><i class="bx bx-edit"></i></a>
                                                    <a onclick="return confirm('Are you sure about that?')" href="<?php echo ASSETS_URL_ROOT . '/admin/delcategory' . '?delid=' . $c_data['CateID'] ?>" class="btn btn-icon btn-sm btn-danger-light product-btn"><i class="bx bx-x-circle"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                <?php
