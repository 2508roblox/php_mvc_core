                                    ...
                                    <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-6">
                                        <div class="card custom-card shadow-none mb-0 border-0">
                                            <div class="card-body p-0">
                                                <div class="row gy-3">
                                                    <div class="col-xl-12"> <label for="product-name-add" class="form-label">Category Name</label> <input name="Name" value="<?php echo $c_data['Name'] ?>" type="text" class="form-control" id="product-name-add" placeholder="Name"> <label for="product-name-add" class="form-label mt-1 fs-12 op-5 text-muted mb-0">*Product
                                            ...
                                            <div class="card-body p-0">
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-xl-6"> <label for="product-status-add" class="form-label">Published Status</label> <select class="form-control" data-trigger name="Status" id="product-status-add">
                                                            ...
                                                            <option <?php echo $c_data['Status'] == '1' ? 'selected' : '' ?> value="1">Published</option>
                                                            <option <?php echo $c_data['Status'] == '0' ? 'selected' : '' ?> value="0">UnPublished</option>
                                                        </select> </div>
