        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="content" data-sal="slide-up" data-sal-duration="800" data-sal-delay="400">
                    ...
                    <a href="<?php echo URL_ROOT ?>/" class="axil-btn btn-bg-secondary right-icon">Back To Home <i class="fa-solid fa-arrow-right-long"></i></a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="thumbnail" data-sal="zoom-in" data-sal-duration="800" data-sal-delay="400">
                    <img src="<?php echo ASSETS_URL_ROOT ?> /client_assets/assets/images/others/404.png" alt="404">
                </div>
            </div>
        </div>
    </div>
