                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="header-top-dropdown">
                            <div class="dropdown">
                                <button class="dropdown-toggle" type="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <div class="col-sm-6">
                        <div class="header-top-link">
                            <ul class="quick-link">
                                <li><a href="#">Help</a></li>
                                <li><a href="user/signup">Join Us</a></li>
                            ...
                            <ul class="mainmenu">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="axil-submenu">
                                        ...
                                        <li><a href="<?php echo ASSETS_URL_ROOT ?>/products/productdetail-2.html">Category 2</a></li>
                                        <li><a href="<?php echo ASSETS_URL_ROOT ?>/products/productdetail-3.html">Category 3</a></li>
                                        <li><a href="<?php echo ASSETS_URL_ROOT ?>/products/productdetail-4.html">Category 4</a></li>
                                        <li><a href="<?php echo ASSETS_URL_ROOT ?>/products/productdetail-5.html">Category 5</a></li>
                                        <li><a href="<?php echo ASSETS_URL_ROOT ?>/products/productdetail-6.html">Category 6</a></li>
                                        <li><a href="<?php echo ASSETS_URL_ROOT ?>/products/productdetail-7.html">Category 7</a></li>
                                    </ul>
                                </li>
