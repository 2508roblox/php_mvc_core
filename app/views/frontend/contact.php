                ...
                <div class="row row--30">
                    <div class="col-lg-8">
                        <div class="contact-form">
                            ...
                            <form method="POST" action="" id="f_f" class="axil-contact-form">
...
>>>>>>> d7a8fdeb9fc983e241e73991b95435d165778bbf
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="Mess" id="contact-message" cols="1" rows="2"></textarea>
                                        </div>
                                    </div>
                                    <input id="s_f" value="Send Message" type="submit" class="axil-btn btn-bg-primary"></input>
                                    <script>
                                        const f = document.querySelector('#f_f');
                                        const s_f = document.querySelector('#s_f');
                                        s_f.addEventListener('click', () => {
                                            f.submit()
                                        })
                                    </script>
                                </div>
